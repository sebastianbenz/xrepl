...
* generated by Xtext
*/
package org.xrepl.xscript.ui.contentassist.antlr;
...
public class XscriptParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xrepl.xscript.ui.contentassist.antlr.internal.InternalXscriptParser createParser() {
		org.xrepl.xscript.ui.contentassist.antlr.internal.InternalXscriptParser result = new org.xrepl.xscript.ui.contentassist.antlr.internal.InternalXscriptParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getXScriptAccess().getAlternatives_1(), "rule__XScript__Alternatives_1");
					put(grammarAccess.getXScriptExpressionAccess().getAlternatives(), "rule__XScriptExpression__Alternatives");
					...
					put(grammarAccess.getXScriptAccess().getGroup(), "rule__XScript__Group__0");
					put(grammarAccess.getXNewEObjectAccess().getGroup(), "rule__XNewEObject__Group__0");
					...
					put(grammarAccess.getXImportAccess().getGroup_1(), "rule__XImport__Group_1__0");
					put(grammarAccess.getXEPackageImportAccess().getGroup(), "rule__XEPackageImport__Group__0");
					put(grammarAccess.getXEPackageImportAccess().getGroup_2(), "rule__XEPackageImport__Group_2__0");
					...
					put(grammarAccess.getXScriptAccess().getExpressionsAssignment_1_0(), "rule__XScript__ExpressionsAssignment_1_0");
					put(grammarAccess.getXScriptAccess().getExpressionsAssignment_1_1(), "rule__XScript__ExpressionsAssignment_1_1");
					put(grammarAccess.getXScriptAccess().getExpressionsAssignment_1_2(), "rule__XScript__ExpressionsAssignment_1_2");
					put(grammarAccess.getXNewEObjectAccess().getTypeAssignment_1(), "rule__XNewEObject__TypeAssignment_1");
					put(grammarAccess.getXImportAccess().getStaticAssignment_1_0(), "rule__XImport__StaticAssignment_1_0");
					put(grammarAccess.getXImportAccess().getExtensionAssignment_1_1(), "rule__XImport__ExtensionAssignment_1_1");
					put(grammarAccess.getXImportAccess().getImportedNamespaceAssignment_2(), "rule__XImport__ImportedNamespaceAssignment_2");
					put(grammarAccess.getXEPackageImportAccess().getNsUriAssignment_1(), "rule__XEPackageImport__NsUriAssignment_1");
					put(grammarAccess.getXEPackageImportAccess().getNameAssignment_2_1(), "rule__XEPackageImport__NameAssignment_2_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.xrepl.xscript.ui.contentassist.antlr.internal.InternalXscriptParser typedParser = (org.xrepl.xscript.ui.contentassist.antlr.internal.InternalXscriptParser) parser;
			typedParser.entryRuleXScript();
