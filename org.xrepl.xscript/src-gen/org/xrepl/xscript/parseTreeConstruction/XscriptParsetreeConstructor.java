...
protected class ThisRootNode extends RootToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 1: return new XScriptExpression_XImportParserRuleCall(this, this, 1, inst);
...
protected class XScript_ExpressionsAssignment_1_1 extends AssignmentToken  {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new XScriptExpression_XImportParserRuleCall(this, this, 0, inst);
			default: return null;
		}	
	}
...
// // | XPackageUse 
// XImport
protected class XScriptExpression_XImportParserRuleCall extends RuleCallToken {
	
	public XScriptExpression_XImportParserRuleCall(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getXScriptExpressionAccess().getXImportParserRuleCall();
	}
