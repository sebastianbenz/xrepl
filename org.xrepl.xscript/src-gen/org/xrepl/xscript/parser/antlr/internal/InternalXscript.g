...
entryRuleXScriptExpression returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getXScriptExpressionRule()); }
	 iv_ruleXScriptExpression=ruleXScriptExpression 
	 { $current=$iv_ruleXScriptExpression.current; } 
	 EOF 
;

// Rule XScriptExpression
ruleXScriptExpression returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    { 
        $current = $this_XImport_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_XEPackageImport_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
(
    ...
    { 
        $current = $this_XNewEObject_13.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleXNewEObject returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getXNewEObjectRule()); }
	 iv_ruleXNewEObject=ruleXNewEObject 
	 { $current=$iv_ruleXNewEObject.current; } 
	 EOF 
;

// Rule XNewEObject
ruleXNewEObject returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='create' 
...
entryRuleXImport returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getXImportRule()); }
	 iv_ruleXImport=ruleXImport 
	 { $current=$iv_ruleXImport.current; } 
	 EOF 
;

// Rule XImport
ruleXImport returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='import' 
...
entryRuleXEPackageImport returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getXEPackageImportRule()); }
	 iv_ruleXEPackageImport=ruleXEPackageImport 
	 { $current=$iv_ruleXEPackageImport.current; } 
	 EOF 
;

// Rule XEPackageImport
ruleXEPackageImport returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='import' 
