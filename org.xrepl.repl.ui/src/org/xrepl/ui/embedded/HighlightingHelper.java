...
public class HighlightingHelper implements IPropertyChangeListener {
	...
	public void install(XtextSourceViewerConfiguration configuration,
		...
		preferenceStoreAccessor.getPreferenceStore().addPropertyChangeListener(
				this);
		enable();
	}
	...
	public void uninstall() {
		disable();
		preferenceStoreAccessor.getPreferenceStore()
	...
	public void setReconcilerProvider(
			Provider<HighlightingReconciler> reconcilerProvider) {
